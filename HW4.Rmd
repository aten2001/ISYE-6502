...
```
According to the graph it looks like day 88 is a good base year since it is around the mean of the means and  it seems to be where the avg daily seasonality is head back to this level at the end of the graph.

Find the sd of that year
```{r}
